...
def get_args():
    ...
    parser.add_argument('--lambda_1', default = None, type = float)
    parser.add_argument('--lambda_2', default = None, type = float)
    parser.add_argument('--thresh_vc', default = None, type = float)
    parser.add_argument('--thresh_lc', default = None, type = float)
    ...
    parser.add_argument('--row_num', default=None, type=int)
...
def merge_config():
    ...
    'weight_decay','momentum','scheduler','steps','lambda_1', 'lambda_2', 'thresh_vc', 'thresh_lc', 'warmup','warmup_iters',
    'use_aux','griding_num', 'row_num', 'note','log_path', 'finetune','resume', 'test_model','test_work_dir']
    for item in items:
